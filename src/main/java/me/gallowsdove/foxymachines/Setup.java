...
final class ItemSetup {
    ...
    public void init() {
        ...
        new SimpleMaterial(Items.REINFORCED_STRING, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                new ItemStack(MaterialCompat.safe(XMaterial.STRING)), SlimefunItems.REINFORCED_ALLOY_INGOT.item(), new ItemStack(MaterialCompat.safe(XMaterial.STRING)),
        ...
        new SimpleMaterial(Items.COMPRESSED_SPONGE, RecipeType.COMPRESSOR, new ItemStack[]{
                new ItemStack(MaterialCompat.safe(XMaterial.SPONGE), 24), null, null,
                null, null, null,
                null, null, null
        }, 1).register(FoxyMachines.getInstance());
        new SimpleMaterial(Items.DEMONIC_INGOT, RecipeType.SMELTERY, new ItemStack[]{
                SlimefunItems.LAVA_CRYSTAL.item(), SlimefunItems.BLISTERING_INGOT_3.item(), new ItemStack(MaterialCompat.safe(XMaterial.GHAST_TEAR)),
        ...
        new SimpleMaterial(Items.AQUATIC_NETHERITE_INGOT, RecipeType.SMELTERY, new ItemStack[]{
                SlimefunItems.DAMASCUS_STEEL_INGOT.item(), new ItemStack(MaterialCompat.safe(XMaterial.NETHERITE_INGOT)), new ItemStack(MaterialCompat.safe(XMaterial.PRISMARINE_SHARD)),
                new ItemStack(MaterialCompat.safe(XMaterial.PRISMARINE_CRYSTALS)), new ItemStack(MaterialCompat.safe(XMaterial.NAUTILUS_SHELL)), null,
                null, null, null
                }, 1).register(FoxyMachines.getInstance());
        new SimpleMaterial(Items.DAMIENIUM, RecipeType.SMELTERY, new ItemStack[]{
                SlimefunItems.DAMASCUS_STEEL_INGOT.item(), SlimefunItems.GOLD_24K.item(), new ItemStack(MaterialCompat.safe(XMaterial.GOLD_INGOT)),
        ...
        new SimpleMaterial(Items.SWEET_INGOT, RecipeType.SMELTERY, new ItemStack[] {
                ...
                new ItemStack(MaterialCompat.safe(XMaterial.HONEYCOMB_BLOCK)), new ItemStack(MaterialCompat.safe(XMaterial.SWEET_BERRIES)), new ItemStack(MaterialCompat.safe(XMaterial.HONEY_BLOCK)),
                null, null, null
                }, 1).register(FoxyMachines.getInstance());
        new SimpleMaterial(Items.SWEETENED_SWEET_INGOT, RecipeType.SMELTERY, new ItemStack[]{
                ...
                new ItemStack(MaterialCompat.safe(XMaterial.SWEET_BERRIES)), new ItemStack(MaterialCompat.safe(XMaterial.SUGAR)), new ItemStack(MaterialCompat.safe(XMaterial.HONEY_BLOCK)),
                null, null, null
                }, 1).register(FoxyMachines.getInstance());
        ...
        new SimpleMaterial(Items.ALTAR_ITEM_GROUP, Items.UNHOLY_WITHER_SKELETON_BONE, FoxyRecipeType.SACRIFICIAL_ALTAR, new ItemStack[] {
                null, null, null,
                null, CustomItemStack.create(MaterialCompat.safe(XMaterial.WITHER_SKELETON_SPAWN_EGG), "&eWither Skeleton Drop"), null,
                null, null, null
                }, 1).register(FoxyMachines.getInstance());
        ...
        new SimpleMaterial(Items.PURIFIED_BONE, RecipeType.ANCIENT_ALTAR, new ItemStack[] {
                new ItemStack(MaterialCompat.safe(XMaterial.BLUE_ORCHID)), new ItemStack(MaterialCompat.safe(XMaterial.ALLIUM)), new ItemStack(MaterialCompat.safe(XMaterial.OXEYE_DAISY)),
                new ItemStack(MaterialCompat.safe(XMaterial.POPPY)), Items.UNHOLY_WITHER_SKELETON_BONE.item(), new ItemStack(MaterialCompat.safe(XMaterial.RED_TULIP)),
                new ItemStack(MaterialCompat.safe(XMaterial.LILY_OF_THE_VALLEY)), new ItemStack(MaterialCompat.safe(XMaterial.PINK_TULIP)), new ItemStack(MaterialCompat.safe(XMaterial.CORNFLOWER))
                }, 1).register(FoxyMachines.getInstance());
        ...
        new SimpleMaterial(Items.BUCKET_OF_BLOOD, RecipeType.MAGIC_WORKBENCH, new ItemStack[] {
                ...
                Items.BLOOD.item(), new ItemStack(MaterialCompat.safe(XMaterial.BUCKET)), Items.BLOOD.item(),
                Items.BLOOD.item(), Items.BLOOD.item(), Items.BLOOD.item()
                }, 1).register(FoxyMachines.getInstance());
        ...
        if (customMobs) {
            ...
            new SimpleMaterial(Items.BOSSES_ITEM_GROUP, Items.PIXIE_QUEEN_HEART, FoxyRecipeType.CUSTOM_MOB_DROP, new ItemStack[]{
                    null, null, null,
                    null, CustomItemStack.create(MaterialCompat.safe(XMaterial.CREEPER_SPAWN_EGG), "&aPixie Queen", "&7Summon it using &aPixie Queen Spawn Egg"), null,
                    null, null, null
                    }, 1).register(FoxyMachines.getInstance());
            new SimpleMaterial(Items.BOSSES_ITEM_GROUP, Items.VILE_PUMPKIN, FoxyRecipeType.CUSTOM_MOB_DROP, new ItemStack[]{
                    null, null, null,
                    null, CustomItemStack.create(MaterialCompat.safe(XMaterial.SPIDER_SPAWN_EGG), "&cHeadless Horseman", "&7Summon it using &cHeadless Horseman Spawn Egg"), null,
                    null, null, null
                    }, 1).register(FoxyMachines.getInstance());
        }
        ...
        new SacrificialAltarPiece(Items.SACRIFICIAL_ALTAR_SOUL_TORCH, new ItemStack[] {
                ...
                null, new ItemStack(MaterialCompat.safe(XMaterial.BLAZE_ROD)), null
                }, 1).register(FoxyMachines.getInstance());
        ...
        new SlimefunItem(Items.TOOLS_ITEM_GROUP, Items.POSEIDONS_FISHING_ROD, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ...
                Items.AQUATIC_NETHERITE_INGOT.item(), null, new ItemStack(MaterialCompat.safe(XMaterial.HEART_OF_THE_SEA))
                }).register(FoxyMachines.getInstance());
        ...
        new SlimefunItem(Items.WEAPONS_AND_ARMORS_ITEM_GROUP, Items.ACRI_ARCUM, RecipeType.ANCIENT_ALTAR, new ItemStack[]{
                Items.EQUANIMOUS_GEM.item(), customMobs ? new ItemStack(MaterialCompat.safe(XMaterial.BOW)) : Items.DEMONIC_PLATE.item(), Items.EQUANIMOUS_GEM.item(),
                Items.BUCKET_OF_BLOOD.item(), customMobs ? Items.VILE_PUMPKIN.item() : new ItemStack(MaterialCompat.safe(XMaterial.BOW)), Items.BUCKET_OF_BLOOD.item(),
                Items.EQUANIMOUS_GEM.item(), customMobs ? new ItemStack(MaterialCompat.safe(XMaterial.BOW)) : Items.DEMONIC_PLATE.item(), Items.EQUANIMOUS_GEM.item()
        }).register(FoxyMachines.getInstance());
        ...
        new BoostedRail(Items.BOOSTED_RAIL, new ItemStack[] {
                ...
                SlimefunItems.LEAD_INGOT.item(), new ItemStack(MaterialCompat.safe(XMaterial.STICK)), SlimefunItems.LEAD_INGOT.item(),
        ...
        new BoostedRail(Items.BOOSTED_ACTIVATOR_RAIL, new ItemStack[] {
                ...
                SlimefunItems.BRASS_INGOT.item(), new ItemStack(MaterialCompat.safe(XMaterial.REPEATER)), SlimefunItems.BRASS_INGOT.item(),
        ...
        new BoostedRail(Items.BOOSTED_DETECTOR_RAIL, new ItemStack[] {
                SlimefunItems.BRASS_INGOT.item(), SlimefunItems.COPPER_WIRE.item(), SlimefunItems.BRASS_INGOT.item(),
                SlimefunItems.BRASS_INGOT.item(), new ItemStack(MaterialCompat.safe(XMaterial.HEAVY_WEIGHTED_PRESSURE_PLATE)), SlimefunItems.BRASS_INGOT.item(),
                SlimefunItems.BRASS_INGOT.item(), SlimefunItems.COPPER_WIRE.item(), SlimefunItems.BRASS_INGOT.item()}, 4)
                .register(FoxyMachines.getInstance());
        ...
        if (customMobs) {
            new CustomMobSpawnEgg(Items.BOSSES_ITEM_GROUP, "PIXIE_QUEEN", Items.PIXIE_QUEEN_SPAWN_EGG, RecipeType.ANCIENT_ALTAR, new ItemStack[]{
                    ...
                    Items.PARROT_FEATHER.item(), new ItemStack(MaterialCompat.safe(XMaterial.EGG)), Items.PARROT_FEATHER.item(),
                    Items.EQUANIMOUS_GEM.item(), Items.DEMONIC_PLATE.item(), Items.EQUANIMOUS_GEM.item()
                    }).register(FoxyMachines.getInstance());
