...
public class HealingBow extends SlimefunBow {
    ...
    public BowShootHandler onShoot() {
        return (e, n) -> {
            n.getWorld().playEffect(n.getLocation(), Effect.STEP_SOUND, MaterialCompat.safe(XMaterial.BRAIN_CORAL));
            n.getWorld().playEffect(n.getEyeLocation(), Effect.STEP_SOUND, MaterialCompat.safe(XMaterial.BRAIN_CORAL));
            e.getDamager().remove();
            e.setCancelled(true);
